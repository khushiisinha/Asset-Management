...
<nav>
    ...
    <form action="" method="post">
        <input type="date" placeholder="CONTRACT EXPIRY DATE" name="search" style="text-transform: uppercase" autocomplete="off">
        <button name="submit">CONTRACT EXPIRY DATE</button>
</div>
</center>
        ...
        if(isset($_POST['submit'])){
            ...
            $sql="select * from `asset_data` where contract_expiry like '$search' ";
