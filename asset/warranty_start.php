...
<nav>
    ...
    <form action="" method="post">
        <input type="date" placeholder="WARRANTY START DATE" name="search" style="text-transform: uppercase" autocomplete="off">
        <button name="submit">WARRANTY START DATE</button>
</div>
</center>
        ...
        if(isset($_POST['submit'])){
            ...
            $sql="select * from `asset_data` where warranty_start like '$search' ";
