...
<nav>
    ...
    <form action="" method="post">
        <input type="text" placeholder="slot" name="search" style="text-transform: uppercase" autocomplete="off">
        <button name="submit">SLOT_NO</button>
</div>
</center>
        ...
        if(isset($_POST['submit'])){
            ...
            $sql="select * from `asset_data` where  slot_number like '$search'  ";
