...
<br><br>
    ...
    if(isset($_GET['asset_id'])){
        ...
        $sql="select * from `user_data` where asset_name like '%$asset_id%'";
   ...
   else if(isset($_GET['slot_id'])){
        $slot_id=$_GET['slot_id'];
        $sql="select * from `user_data` where slot_number=$slot_id";
        //echo"$asset_id";
        $result=mysqli_query($con,$sql);
    ...
    {    if(mysqli_num_rows($result)>0){
     ...
     <tbody>';
     $c=0;
     $sql2="select * from `user_data` where slot_number=$slot_id";
        //echo"$asset_id";
