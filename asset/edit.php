...
<nav>
        ...
        echo"<br><br>"; echo"<center>";
         for($btn=1;$btn<=$total_pages;$btn++){
            echo'<button class="button-page" style="margin-right:10px;" ><a style="text-decoration:none; padding-left:5px; padding-right:5px; height:5px; font-weight:700; border-radius:5;" href="edit.php?page='.$btn.'"  > '.$btn.'</a></button>'; 
...
';
    ...
    if($days_remaining<7 && $days_remaining>0){
        ...
        <td bgcolor="blue"><button name="edit"><a style="text-decoration:none; padding-left:5px; padding-right:5px; height:5px; font-weight:700; border-radius:5;" href="update.php?editid='.$id.'">EDIT</a></td>
