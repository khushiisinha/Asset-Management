...
if(isset($_POST['submit'])){
    ...
    $sql="INSERT INTO `user_data`(slot_number,asset_name,emp_id,user_name,mobile_number,area,expected_installation,actual_installation,remarks)
     VALUES ('$slot_number','$asset_name','$emp_id','$user_name','$mobile_number','$area','$expected_installation','$actual_installation','$remarks')";
...
<nav>
       ...
       <form action="" method="POST">
        ...
        <hr>
         ...
         <div>
         <input type="text" autocomplete="off" name="lot_number" style="text-transform:uppercase" class="box"></div>
         <br><br>
         <div><label for="">ASSET NAME</label></div>
         <div>
         <input type="text" autocomplete="off" name="asset_name" style="text-transform:uppercase" class="box"></div>
         <br><br>
         <div><label for="">EMP ID NUMBER</label></div>
         <div>
         <input type="text" autocomplete="off" name="emp_id" style="text-transform:uppercase" class="box"></div>
         <br><br>
         <div><label for="">USER NAME</label></div>
         <div>
         <input type="text" autocomplete="off" name="user_name" style="text-transform:uppercase" class="box"></div>
         <br><br>
         <div><label for="">MOBILE NO.</label></div>
         <div>
         <input type="tel" autocomplete="off" name="mobile_number" style="text-transform:uppercase" class="box"></div>
         <br><Br>
         
         <div><label for="">AREA</label></div>
         <div>
         <input type="text" autocomplete="off" name="area" style="text-transform:uppercase" class="box"></div>
         <br><Br>
         <div><label for="">EXPECTED INSTALLATION DATE</label></div>
         <div>
         <input type="date" autocomplete="off" name="expected_installation" style="text-transform:uppercase" class="box"></div>
         <br><br>
         <div><label for="">ACTUAL INSTALLATION DATE</label></div>
         <div>
         <input type="date" autocomplete="off" name="actual_installation" style="text-transform:uppercase" class="box"></div>
         <br><br>
         <div><label for="">REMARKS</label></div>
         <div><textarea name="remarks" id="" cols="106" rows="4"  class="box-text"></textarea></div><br><Br>
