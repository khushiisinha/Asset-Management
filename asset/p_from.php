...
<nav>
    ...
    <form action="" method="post">
        <input type="text" placeholder="FROM" name="search" style="text-transform: uppercase" autocomplete="off">
        <button name="submit">PURCHASED FROM</button>
</div>
</center>
       ...
       <table>
        ...
        if(isset($_POST['submit'])){
            ...
            $sql="select * from `crud` where  p_from like '%$search%' ";
