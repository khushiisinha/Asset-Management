...
$total_pages=ceil($num/$number_pages);
 ...
 for($btn=1;$btn<=$total_pages;$btn++){
    echo'<button class="button-page" style="margin-right:10px;" ><a style="text-decoration:none; padding-left:5px; padding-right:5px; height:5px; font-weight:700; border-radius:5;" href="mouse.php?page='.$btn.'"  > '.$btn.'</a></button>'; 
}
...
<?php
 ...
 $sql="select * from  `user_data` where asset_name='MOUSE' limit ".$starting_limit.','.$number_pages;
