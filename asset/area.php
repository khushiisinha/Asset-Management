...
<nav>
    ...
    <form action="" method="post">
        <input type="text" placeholder="AREA" name="search" style="text-transform: uppercase" autocomplete="off">
        <button name="submit">AREA</button>
</div>
</center>
        ...
        if(isset($_POST['submit'])){
            ...
            $sql="select * from `asset_data` where  area like '%$search%'";
