...
<nav>
            ...
            <div class="menu">
                <ul>
            <li><button><a href="slot.php" class="active">SLOT_NO</a></button></li>
            <li><button><a href="device.php" class="active">ASSET NAME</a></button></li>
            <li><button><a href="area.php" class="active">AREA WISE</a></button></li>
            <li><button><a href="contract_start.php" class="active">CONTRACT START</a></button></li>
            <li><button><a href="contract_expiry.php" class="active">CONTRACT EXPIRY</a></button></li>
            <li><button><a href="warranty_start.php" class="active">WARRANTY START</a></button></li>
            <li><button><a href="warranty_expiry.php" class="active">WARRANTY EXPIRY</a></button></li>
</div>
...
<?php
  ...
  echo"<br><Br>";echo'<center>';
   for($btn=1;$btn<=$total_pages;$btn++){
      echo'<button class="button-page" style="margin-right:10px;"><a style="text-decoration:none; padding-left:5px; padding-right:5px; height:5px; font-weight:700; border-radius:5;" href="view.php?page='.$btn.'"> '.$btn.'</a></button>';
   }
   if(isset($_GET['page'])){
    $page=$_GET['page'];
