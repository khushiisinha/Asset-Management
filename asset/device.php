...
<nav>
    ...
    <form action="" method="post">
        <input type="text" placeholder="ASSET NAME" name="search" style="text-transform: uppercase" autocomplete="off">
        <button name="submit">ASSET NAME</button>
</div>
</center>
        ...
        if(isset($_POST['submit'])){
            ...
            $sql="select * from `asset_data` where asset_name like '%$search%' ";
