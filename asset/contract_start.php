...
<nav>
    ...
    <form action="" method="post">
        <input type="date" placeholder="CONTRACT START DATE" name="search" style="text-transform: uppercase" autocomplete="off">
        <button name="submit">CONTRACT START DATE</button>
</div>
</center>
        ...
        if(isset($_POST['submit'])){
            ...
            $sql="select * from `asset_data` where contract_start like '$search' ";
